<template>
    <div>
        <div class="control-group" :class="[errors.has('country') ? 'has-error' : '']">
            <select type="text" v-validate="'required'" class="control" id="country" name="country" v-model="address.country" data-vv-as="Country">
                <option value=""></option>
        ...
        <div class="control-group" :class="[errors.has('state') ? 'has-error' : '']">
            <input type="text" v-validate="'required'" class="control" id="state" name="state" v-model="address.state" v-if="! haveStates()" data-vv-as="State" placeholder="State"/>

            <select v-validate="'required'" class="control" id="state" name="state" v-model="address.state" v-if="haveStates()" data-vv-as="State">
