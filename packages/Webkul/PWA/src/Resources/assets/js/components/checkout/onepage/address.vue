<template>
    <div>
        <div class="control-group" :class="[errors.has('address-form.' + type + '[first_name]') ? 'has-error' : '']">
            <input type="text" :name="type + '[first_name]'" class="control" v-model="address.first_name" v-validate="'required'" placeholder="First Name" data-vv-as='"First Name"'/>
        ...
        <div class="control-group" :class="[errors.has('address-form.' + type + '[last_name]') ? 'has-error' : '']">
            <input type="text" :name="type + '[last_name]'" class="control" v-model="address.last_name" v-validate="'required'" placeholder="Last Name" data-vv-as='"Last Name"'/>
        ...
        <div class="control-group" :class="[errors.has('address-form.' + type + '[email]') ? 'has-error' : '']">
            <input type="text" :name="type + '[email]'" class="control" v-model="address.email" v-validate="'required'" placeholder="Email" data-vv-as='"Email"'/>
            <label>Email</label>
        ...
        <div class="control-group" :class="[errors.has('address-form.' + type + '[address1][]') ? 'has-error' : '']">
            <input type="text" :name="type + '[address1][]'" class="control" v-model="address.address1[0]" v-validate="'required'" placeholder="Street Address 1" data-vv-as='"Street Address 1"'/>
        ...
        <div class="control-group" :class="[errors.has('address-form.' + type + '[city]') ? 'has-error' : '']">
            <input type="text" :name="type + '[city]'" class="control" v-model="address.city" v-validate="'required'" placeholder="City" data-vv-as='"City"'/>
            <label>City</label>
        ...
        <div class="control-group" :class="[errors.has('address-form.' + type + '[postcode]') ? 'has-error' : '']">
            <input type="text" :name="type + '[postcode]'" class="control" v-model="address.postcode" v-validate="'required'" placeholder="Postal Code" data-vv-as='"City"'/>
        ...
        <div class="control-group" :class="[errors.has('address-form.' + type + '[phone]') ? 'has-error' : '']">
            <input type="text" :name="type + '[phone]'" class="control" v-model="address.phone" v-validate="'required'" placeholder="Phone" data-vv-as='"City"'/>
            <label>Phone</label>
