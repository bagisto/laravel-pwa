...
var allCaches = [staticCache, serverCache, outSideCache];
...
function fallBackResponse(type) {
    switch (type) {
        case "post":
            ...
            var body = {
                success:
                    "You are offline right now, we stored your data and will sync it as soon as you will get online.",
            };
