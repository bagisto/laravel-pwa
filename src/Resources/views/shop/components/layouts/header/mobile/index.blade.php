    ...
    <div class="w-full flex justify-between items-center">
            ...
            >
                ...
                <x-slot:content>
                    ...
                    <div class="absolute w-full flex bottom-0 left-0 bg-white shadow-lg p-4 gap-x-5 justify-between items-center mb-4">
                        <x-shop-pwa::dropdown position="top-left">
                            <!-- Dropdown Toggler -->
                            <x-slot:toggle>
                        ...
                        <x-shop-pwa::dropdown position="top-right">
                            <x-slot:toggle>
                                <!-- Dropdown Toggler -->
                                <div
        ...
        <div>
            <div class="flex items-center gap-x-5">
                ...
                <x-shop-pwa::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
                    <x-slot:toggle>
