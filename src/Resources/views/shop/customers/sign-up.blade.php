	...
	<div class="container mt-20 max-1180:px-5">
        ...
        >
            ...
            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop-pwa::form :action="route('pwa.customers.register.store')">
                    ...
                    <x-shop-pwa::form.control-group class="mb-6">
                        <x-shop-pwa::form.control-group.label class="required">
                        ...
                        <x-shop-pwa::form.control-group.error control-name="password" />
                    </x-shop-pwa::form.control-group>
                    ...
                    <x-shop-pwa::form.control-group>
                        ...
                        <x-shop-pwa::form.control-group.error control-name="password_confirmation" />
                    </x-shop-pwa::form.control-group>
			...
			<p class="mt-5 text-[#6E6E6E] font-medium">
                ...
                <a class="text-navyBlue"
                    href="{{ route('pwa.customer.session.index') }}"
                >
