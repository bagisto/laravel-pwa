    ...
    <div class="container mt-20 max-1180:px-5">
        ...
        >
            ...
            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop-pwa::form :action="route('pwa.customer.session.create')">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="block">
                            <a
                                href="{{ route('pwa.customers.forgot_password.create') }}"
            ...
            <p class="mt-5 text-[#6E6E6E] font-medium">
                ...
                <a
                    class="text-navyBlue"
                    href="{{ route('pwa.customers.register.index') }}"
                >
