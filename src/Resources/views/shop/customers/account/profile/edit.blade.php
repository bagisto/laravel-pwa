<x-shop-pwa::layouts.account>
    ...
    <!-- Breadcrumbs -->
    @section('breadcrumbs')
        <x-shop-pwa::breadcrumbs name="profile.edit" />
    @endSection
    ...
    >
        ...
        <x-shop-pwa::form.control-group class="mt-4">
            ...
            <x-shop-pwa::form.control-group.error control-name="image[]" />
        ...
        <x-shop-pwa::form.control-group>
            ...
            <x-shop-pwa::form.control-group.error control-name="gender" />
        </x-shop-pwa::form.control-group>
        ...
        <x-shop-pwa::form.control-group>
            ...
            <x-shop-pwa::form.control-group.error control-name="current_password" />
        </x-shop-pwa::form.control-group>
        ...
        <x-shop-pwa::form.control-group>
            ...
            <x-shop-pwa::form.control-group.error control-name="new_password" />
        </x-shop-pwa::form.control-group>
        ...
        <x-shop-pwa::form.control-group>
            ...
            <x-shop-pwa::form.control-group.error control-name="new_password_confirmation" />
        </x-shop-pwa::form.control-group>
