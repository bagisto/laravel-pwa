    ...
    <div class="mt-5">
        <x-shop-pwa::tabs>
            ...
            @if ($order->invoices->count())
                <x-shop-pwa::tabs.item  :title="trans('shop::app.customers.account.orders.view.invoices.invoices')">
            ...
            @if ($order->shipments->count())
                <x-shop-pwa::tabs.item title="{{ trans('shop::app.customers.account.orders.view.shipments.shipments') }}">
            ...
            @if ($order->refunds->count())
                <x-shop-pwa::tabs.item :title="trans('shop::app.customers.account.orders.view.refunds.refunds')">
